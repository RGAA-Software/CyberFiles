...
pub use config::{
    ...
    save_file_browser_prefs, sidebar_is_compact, sidebar_is_offcanvas, AppConfig, FileTagConfig,
    load_config, save_config, window_size, VIEW_COLUMNS, VIEW_DETAILS, VIEW_GRID,
};
