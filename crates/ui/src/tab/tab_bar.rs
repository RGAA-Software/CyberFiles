...
use gpui::{
    div, px, Anchor, Animation, AnimationExt as _, AnyElement, App, Bounds, Div, Edges, ElementId,
...
impl TabBar {
    ...
    /// Use a title-bar specific medium size: keep Medium typography/spacing semantics,
    /// but stretch the Tab variant to match the 34px title bar height.
    pub fn medium_titlebar(mut self) -> Self {
        self.size = Size::Medium;
        self.medium_titlebar = true;
        self
    }
